...
/* Rofi controls */
static const char *applicationmenu[]  = { "application_menu", NULL };

/* Terminal control*/
static const char *termcmd[]  = { "alacritty", NULL };

/* Audio controls */
static const char *mutecmd[] = { "volume_mgr", "--m", NULL };
static const char *volupcmd[] = { "volume_mgr", "--inc", NULL };
static const char *voldowncmd[] = { "volume_mgr", "--dec", NULL };

/* Backlight conrol */
static const char *brightnessup[] = {"brightness_mgr", "--inc", NULL  };
static const char *brightnessdown[] = { "brightness_mgr", "--dec", NULL  };

/* Screenshot control */
static const char *screenshot[] = { "screenshot_mgr", NULL };

/* Lock screen control */
static const char *slock[] = { "slock" };

/* Wifi menu */
static const char *wifimenu[] = { "wifi_menu" , NULL};
